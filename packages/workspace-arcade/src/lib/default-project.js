  ...
  return {
    assetList: [
      Object.assign(DEFAULT_BACKDROP, {
        name: `${getText('arcade.defaultProject.backdropName', 'backdrop')}1`,
      }),
      Object.assign(DEFAULT_COSTUME_1, {
        name: `${getText('arcade.defaultProject.costumeName', 'costume')}1`,
      }),
      Object.assign(DEFAULT_COSTUME_2, {
        name: `${getText('arcade.defaultProject.costumeName', 'costume')}2`,
      }),
    ],
    fileList: [
      {
        id: 'stage',
        type: 'text/x-python',
        name: getText('arcade.defaultProject.stageName', 'Stage'),
      ...
      },
      {
        id: 'sprite1',
        type: 'text/x-python',
        name: `${getText('arcade.defaultProject.spriteName', 'Sprite')}1`,
