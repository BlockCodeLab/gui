  ...
  return {
    assetList: [
      ...
      Object.assign(DEFAULT_BACKDROP, {
        name: getText('arcade.defaultProject.backdropName', 'backdrop1'),
      }),
      Object.assign(DEFAULT_COSTUME_1, {
        name: getText('arcade.defaultProject.costumeName1', 'costume1'),
      }),
      Object.assign(DEFAULT_COSTUME_2, {
        name: getText('arcade.defaultProject.costumeName2', 'costume2'),
      }),
    ],
    fileList: [
      {
      ...
      },
      {
        id: 'sprite1',
        type: 'text/x-python',
        name: getText('arcade.defaultProject.spriteName', 'Sprite1'),
