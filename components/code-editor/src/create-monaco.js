...
window.MonacoEnvironment = {
  getWorker: (_, label) => {
    switch (label) {
      case 'json':
        return new Worker('/workers/json-worker.js', { type: 'module' });
      case 'javascript':
      case 'typescript':
        return new Worker('/workers/ts-worker.js', { type: 'module' });
      default:
        return new Worker('/workers/editor-worker.js', { type: 'module' });
    }
  },
};
